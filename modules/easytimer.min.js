...
function startTimer() {
    ...
    timer.addEventListener('secondsUpdated', function (e) {
        ...
        console.log('tiotal minuter '+tiotalMinuter)
        console.log('ental minuter '+entalMinuter)
        console.log('tiotal sekunder '+tiotalSekunder)
        console.log('ental sekunder '+entalSekunder)
        arrayNumbers= [];
    });
