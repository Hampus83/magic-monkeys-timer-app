            ...
            if (numberPosition== arrayNumbers[0]){
                ...
                for(let j = 0; j < number.length; j++) {
                    if(number[j].number == tiotalMinuter){
                        document.querySelector('#minutes-ten').innerText = `${number[i].spelled}TIO`;
                    }
                }  
                ...
                for(let j = 0; j < number.length; j++) {
                    if(number[j].number == entalMinuter){
                        document.querySelector('#minutes').innerText = `${number[i].spelled} MINUTER`;
                    }
                }   
                ...
                for(let j = 0; j < number.length; j++) {
                    if(number[j].number == tiotalSekunder){
                        document.querySelector('#seconds-ten').innerText = `${number[i].spelled}TIO`;
                    }
                }   
                ...
                for(let j = 0; j < number.length; j++) {
                    if(number[j].number == entalSekunder){
                        document.querySelector('#seconds').innerText = `${number[i].spelled}`;
                    }
                }   
            }
        }
